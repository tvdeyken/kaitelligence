...
VENUE_ID = '5284ca5411d2db068c69eff3'
BASE_URL = "https://api.foursquare.com/v2/venues/#{VENUE_ID}/"

CLIENT_ID = 'NTGK300FD5TAYKNDCUBJXXK2YDLXGYLNOQ4GSQMVJWRBDVTG'
CLIENT_SECRET = 'KBTYI5RDHGW3CUR3YH4WN4DNGP322QUZH5ZFSQVGDZDU2GLO'
ACCESS_TOKEN = 'INSERT ACCESS TOKEN HERE'

SCHEDULER.every '1m', :first_in => 0 do |job|

  options = {:client_id => CLIENT_ID, :client_secret => CLIENT_SECRET, :v => "20130714"}
